...
export class WarmupPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public alerCtrl: AlertController, public toastCtrl: ToastController) {
    this.cardz = [
      {id: '2', name: 'Trainer A', title: '10x Push-Ups', content: 'Push-Ups are a great way to warm up and build up your muscle mass. The whole body needs more muscles in order to be able to increase your vertical.', code: 1, isrc: "../assets/img/pushups_animation.gif", ppsrc: "assets/imgs/a.jpeg"},
      {id: '1',name: 'Trainer B', title: 'Stretch', content: "It is cruicial that you stretch before exercising. You should focus on leg stretches since you'll mainly be training your legs.",code: 2, isrc: "assets/img/stretch_animation.gif", ppsrc: "assets/imgs/b.jpeg"},
